...
# -- Context remaining --
# Thresholds tuned for 1M context: yellow at 25% used, red at 50% used.
# Anthropic's MRCR v2 shows retrieval accuracy drops from 93% at 256K to
# 76-78% at 1M, so rot is a gradient, not a cliff. Red at 50% used matches
# observed quality degradation, early enough to start a fresh session.
